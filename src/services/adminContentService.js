...
export const testimonialsService = {
  ...
  async getAll() {
    ...
    try {
      ...
      console.error('Error in testimonialsService.getAll:', err);
      return [];
    }
  },
  ...
  async getActive() {
    ...
    try {
      ...
      console.error('Error in testimonialsService.getActive:', err);
      return [];
    }
  },
  ...
  async getFeatured() {
    ...
    try {
      ...
      console.error('Error in testimonialsService.getFeatured:', err);
      return [];
    }
  },
...
export const faqsService = {
  ...
  async getAll() {
    ...
    try {
      ...
      console.error('Error in faqsService.getAll:', err);
      return [];
    }
  },
  ...
  async getActive() {
    ...
    try {
      ...
      console.error('Error in faqsService.getActive:', err);
      return [];
    }
  },
  ...
  async getByCategory(category) {
    ...
    try {
      ...
      console.error('Error in faqsService.getByCategory:', err);
      return [];
    }
  },
...
export const quotesService = {
  ...
  async getAll() {
    ...
    try {
      ...
      console.error('Error in quotesService.getAll:', err);
      return [];
    }
  },
  ...
  async getActive() {
    ...
    try {
      ...
      console.error('Error in quotesService.getActive:', err);
      return [];
    }
  },
  ...
  async getRandom() {
    ...
    try {
      ...
      console.error('Error in quotesService.getRandom:', err);
      return null;
    }
  },
  ...
  async getByCategory(category) {
    ...
    try {
      ...
      console.error('Error in quotesService.getByCategory:', err);
      return [];
    }
  },
...
export const offersService = {
  ...
  async getAll() {
    ...
    try {
      ...
      console.error('Error in offersService.getAll:', err);
      return [];
    }
  },
  ...
  async getPrimary() {
    try {
      ...
      console.error('Error in offersService.getPrimary:', err);
      return null;
    }
  },
...
export const siteStatsService = {
  ...
  async get() {
    ...
    try {
      ...
      console.error('Error in siteStatsService.get:', err);
      return null;
    }
  },
  ...
  async update(stats) {
    ...
    try {
      ...
      console.error('Error in siteStatsService.update:', err);
      return null;
    }
  },
  ...
  async calculateFromData() {
    ...
    try {
      ...
      console.error('Error in siteStatsService.calculateFromData:', err);
      return null;
    }
  }
};
...
export const usersService = {
  ...
  async getWithGoals() {
    ...
    try {
      ...
      console.error('Error in getWithGoals:', err);
      return [];
    }
  },
  ...
  async getStats() {
    if (!isSupabaseConfigured()) {
      return { total: 0, newThisWeek: 0, newThisMonth: 0, avgIntegrityScore: 0 };
    }
