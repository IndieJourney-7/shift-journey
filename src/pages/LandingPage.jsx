    ...
    <div className="min-h-screen bg-obsidian-950 noise-bg">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-obsidian-400 text-lg md:text-xl mb-8 max-w-lg mx-auto lg:mx-0">
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-obsidian-300 text-lg font-medium">No Escape, Only Progress</h2>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-obsidian-800 border border-obsidian-600 flex items-center justify-center">
                <Target className="w-6 h-6 text-obsidian-400" />
              </div>
              <h3 className="text-obsidian-200 font-semibold mb-2">
            ...
            <div className="text-center p-6">
              <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-obsidian-800 border border-obsidian-600 flex items-center justify-center">
                <Lock className="w-6 h-6 text-obsidian-400" />
              </div>
              <h3 className="text-obsidian-200 font-semibold mb-2">
            ...
            <div className="text-center p-6">
              <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-obsidian-800 border border-obsidian-600 flex items-center justify-center">
                <Brain className="w-6 h-6 text-obsidian-400" />
              </div>
              <h3 className="text-obsidian-200 font-semibold mb-2">
      ...
      <section id="how-it-works" className="py-20 px-4 bg-obsidian-900/30">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-obsidian-100 mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="p-6">
              <div className="text-gold-500 text-2xl font-bold mb-3">1</div>
              <h3 className="text-obsidian-100 font-semibold text-lg mb-3">Break It Down</h3>
            ...
            <div className="p-6">
              <div className="text-gold-500 text-2xl font-bold mb-3">2</div>
              <h3 className="text-obsidian-100 font-semibold text-lg mb-3">Lock Each Promise</h3>
              <p className="text-obsidian-400 text-sm">
            ...
            <div className="p-6">
              <div className="text-gold-500 text-2xl font-bold mb-3">3</div>
              <h3 className="text-obsidian-100 font-semibold text-lg mb-3">Commit Without Escape</h3>
              <p className="text-obsidian-400 text-sm">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-obsidian-100 mt-12 mb-4">
      ...
      {/* Footer */}
      <footer className="py-8 px-4 border-t border-obsidian-800">
